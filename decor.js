...
function renderDecorProducts(productsToRender = null) {
    const decorProducts = productsToRender || products.filter(product => product.category === 'decor');
    const productsGrid = document.getElementById('decor-products-grid');
    
    if (!productsGrid) return;
    
    productsGrid.innerHTML = '';
    
    decorProducts.forEach((product, index) => {
...
function filterDecorProducts(filter) {
    const decorProducts = products.filter(product => product.category === 'decor');
